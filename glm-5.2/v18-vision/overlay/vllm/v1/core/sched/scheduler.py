        ...
        if acceptance_length_controller is not None:
            ...
            if (
                ...
                logger.info(
                    ...
                    ",".join(
                        f"{rate:.2f}"
                        for rate in update.position_conditional_acceptance[:5]
                    ),
                )
